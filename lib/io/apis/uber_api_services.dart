...
class ApiProvider {
  final String _baseUrl ='https://api.uber.com';
  ...
  Future<dynamic> get(String url, headers) async {
    ...
    _dioClient.interceptors.add(InterceptorsWrapper(onRequest: (options) {
      var headers = {
    ...
    try {
      Response response = await _dioClient.get(_baseUrl + "/v1.2/products?latitude=37.7752315&longitude=-122.418075");
